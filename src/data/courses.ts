...
export const courses: CourseMeta[] = [
  {
    ...
    description:
      'Fundamentos de lógica e programação estruturada para resolver problemas do dia a dia.',
  },
  {
    id: 'tdjd',
  ...
  },
  {
    ...
    description:
      'Modelagem com classes, encapsulamento, herança e padrões de projeto introdutórios.',
  },
];
